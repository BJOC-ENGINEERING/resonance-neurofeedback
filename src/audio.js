...
export class AudioEngine {
  ...
  playCue(kind) {
    if (kind === 'start') { this.playChime(392.0, 0.12); setTimeout(() => this.playChime(523.25, 0.12), 180); }
    else { this.playChime(523.25, 0.14); setTimeout(() => this.playChime(392.0, 0.14), 220); setTimeout(() => this.playChime(261.63, 0.12), 440); }
  }
